...
public class OrOperator extends AbstractOperator {
	...
	public OrOperator(AbstractOperator op1, AbstractOperator op2) {
		this();
	...
	private static boolean needBrackets(AbstractOperator op) {
		...
		return !((op instanceof StateOperator) || (op instanceof OrOperator) || (op instanceof NotOperator));
	}
	...
	public void paintOperator(Graphics2D g, boolean considerHighlighting) {
		...
		g.setFont(this.font);
		Utils.paintTextCentered(g, "OR", this.getCenterLineX(), textCenterPosY);
	}
