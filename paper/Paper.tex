...
% Gefundene probleme, die man erw�hnen k�nnte: beim if operator ist das �bergeordnete always nicht intuitiv.
...
%Der Editor wurde in robostudio eingebunden, ein werkzeug zur erstellung von healthcare applicationen (elderly) basierend auf zustandsmaschinen. (bereits in der einleitung erw�hnt). �ber die darin definierbaren zustansmaschinen k�nnen wir nun aussagen mit der vl erstellen.
...
%basierend auf diesen healthcare applicationen k�nnen nun sicherheits constraints �ber unser tool definiert werden.
